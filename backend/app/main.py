    ...
    async def create(self) -> AgentRuntime:
        ...
        tools = SessionNutritionToolAdapter(
            planning_selection_policy=MealSelectionPolicy(
                ...
                flavour_diversity_weight=self._settings.planning_flavour_diversity_weight,
                bundle_enabled=self._settings.planning_bundle_enabled,
                bundle_options_per_role=self._settings.planning_bundle_options_per_role,
                bundle_max_combinations=self._settings.planning_bundle_max_combinations,
                bundle_seconds=self._settings.planning_bundle_seconds,
                bundle_staple_weight=self._settings.planning_bundle_staple_weight,
                bundle_protein_weight=self._settings.planning_bundle_protein_weight,
                bundle_vegetable_weight=self._settings.planning_bundle_vegetable_weight,
