# Phase 2 双角色专家复审空白表（当前 code-eval）
...
- 当前 code-eval SHA-256：`85971eb9bd268d42dfca755783ce116fd7c0aff70079c1b8c1c82c0b1517da60`。填写前仍须重新运行 `shasum -a 256 backend/evals/phase2-code-eval.json`；若结果变化，必须重新审阅并逐条写入新值，绝不能使用旧 Summary 的 SHA。
...
| phase02-006 | missing_ambiguity | 于：food_code=true; blocking_fields=true; household_portion_auditability=true; authoritative_values=true; hard_validation=true | 陈：food_code=true; blocking_fields=true; household_portion_auditability=true; authoritative_values=true; hard_validation=true | 于=5/5；陈=5/5 |
| phase02-007 | missing_ambiguity | 于：food_code=true; blocking_fields=true; household_portion_auditability=true; authoritative_values=true; hard_validation=true | 陈：food_code=true; blocking_fields=true; household_portion_auditability=true; authoritative_values=true; hard_validation=true | 于=4/5；陈=5/5 |
| phase02-008 | missing_ambiguity | 于：food_code=true; blocking_fields=true; household_portion_auditability=true; authoritative_values=true; hard_validation=true | 陈：food_code=true; blocking_fields=true; household_portion_auditability=true; authoritative_values=true; hard_validation=true | 于=5/5；陈=5/5 |
| phase02-009 | missing_ambiguity | 于：food_code=true; blocking_fields=true; household_portion_auditability=true; authoritative_values=true; hard_validation=true | 陈：food_code=true; blocking_fields=true; household_portion_auditability=true; authoritative_values=true; hard_validation=true | 于=5/5；陈=4/5 |
| phase02-010 | missing_ambiguity | 于：food_code=true; blocking_fields=true; household_portion_auditability=true; authoritative_values=true; hard_validation=true | 陈：food_code=true; blocking_fields=true; household_portion_auditability=true; authoritative_values=true; hard_validation=true | 于=4/5；陈=5/5 |
