...
| phase02-010 | missing_ambiguity | 于：food_code=true; blocking_fields=true; household_portion_auditability=true; authoritative_values=true; hard_validation=true | 陈：food_code=true; blocking_fields=true; household_portion_auditability=true; authoritative_values=true; hard_validation=true | 于=5/5；陈=5/5 |
