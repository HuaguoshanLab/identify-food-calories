...
- 当前 code-eval SHA-256：`df7dbdf3ebc5908c716c082922397f9f687fa2b5243a9f7576bac8dda6acf63c`。填写前仍须重新运行 `shasum -a 256 backend/evals/phase2-code-eval.json`；若结果变化，必须重新审阅并逐条写入新值，绝不能使用旧 Summary 的 SHA。
