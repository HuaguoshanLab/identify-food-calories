...
export function VectorRetrievalPage() {
  ...
  const query = useQuery({ queryKey: ['vector-space-builds'], queryFn: () => listVectorBuilds(accessToken!), enabled: Boolean(accessToken), retry: false, refetchInterval: 5_000 })
