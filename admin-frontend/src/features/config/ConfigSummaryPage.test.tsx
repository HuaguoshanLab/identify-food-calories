...
describe('AdminRouteGuard 与 RuntimeConfigSummaryPage', () => {
  it('probe 成功后才渲染嵌套路由；401 清除会话和 Query cache，403 固定拒绝', async () => {
    ...
    const { rerender } = render(<GuardFixture queryClient={queryClient} />)
    ...
    rerender(<GuardFixture queryClient={queryClient} />)
    ...
    rerender(<GuardFixture queryClient={new QueryClient()} />)
