...
export function SettingsLinkRow({ description, icon: Icon, title, to }: SettingsLinkRowProps) {
  return (
    <Link
      className="flex min-h-14 items-center gap-3 border-b border-border py-3 text-foreground transition-colors hover:bg-muted focus-visible:outline-none"
      to={to}
    >
      <Icon aria-hidden="true" className="h-5 w-5 shrink-0 text-muted-foreground" strokeWidth={2} />
