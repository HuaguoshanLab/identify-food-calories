...
export function PersonalProfilePage() {
  ...
  return (
    <section className="space-y-5" aria-labelledby="personal-profile-content-title">
      <div>
        <h2 className="text-xl font-semibold" id="personal-profile-content-title">身体资料与目标</h2>
