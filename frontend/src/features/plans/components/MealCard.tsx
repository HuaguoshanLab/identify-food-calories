  ...
  return (
    <Card aria-labelledby={`meal-${meal.slot}-title`}>
      <CardHeader className="space-y-1">
        <div className="flex items-center gap-2"><h3 className="text-base font-semibold leading-none" id={`meal-${meal.slot}-title`}>{slotLabels[meal.slot]}</h3>{adjustment ? <Badge>已调整</Badge> : null}</div>
